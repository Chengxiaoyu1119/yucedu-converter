...
1. 从仓库的 [Releases](../../releases/tag/v2.0.1) 页面获取 `yucedu-converter-v2.0.1-windows-x64.zip`。
2. 完整解压 ZIP。
...
- [使用说明](docs/使用说明.md)
- [转换格式说明](docs/转换格式说明.md)
- [Windows 构建说明](docs/Windows构建说明.md)
- [发布包目录说明](docs/发布包目录说明.md)
- [测试与兼容报告](docs/测试与兼容报告.md)
- [多平台路线图](docs/多平台路线图.md)
- [上游播放器来源](docs/research/上游播放器来源.md)
- [MacNetPlayer 本地分析](docs/research/MacNetPlayer本地分析.md)
